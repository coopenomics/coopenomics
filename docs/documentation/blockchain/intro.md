...
Программное обеспечение узла и инструментов сети — **COOPOS**. Ресурсы (**powerup**), регистрация аккаунтов и контракты описаны в разделе **cleos**: [Ресурсы сети, регистрация и контракты](system-resources.md). Установка, **nodeos**, **cleos**, **keosd** и полная справка по командам: [Программы узла и справка](coopos/index.md).