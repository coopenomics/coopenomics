...
Программное обеспечение узла и инструментов сети — **COOPOS**. Чтобы дальше не теряться в плагинах и API, имеет смысл пройти [концептуальную модель COOPOS](system-model.md), затем — [аккаунты и разрешения](accounts.md), [ключи и подписи](keys-signatures.md), [действия и транзакции](transactions.md).

Ресурсы (**powerup**), регистрация аккаунтов и контракты описаны в разделе **cleos**: [Ресурсы сети, регистрация и контракты](system-resources.md). Установка, **nodeos**, **cleos**, **keosd** и полная справка по командам: [Программы узла и справка](coopos/index.md); краткий состав стека — [Программы (инструменты COOPOS)](programs.md).