...
Операционная система кооперативной экономики опирается на стек **COOPOS**: компоненты и библиотеки для управления узлами распределённого реестра, сбора данных, взаимодействия с сетью и разработки смарт-контрактов. 
