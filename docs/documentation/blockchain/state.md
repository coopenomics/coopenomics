...
Распределённое хранилище состояния — встроенная подсистема узла: данные смарт-контрактов организованы в **таблицы** в RAM аккаунтов. Изменение данных осуществляется через специальные методы, называемые действиями, которые задаются в коде смарт-контрактов.
