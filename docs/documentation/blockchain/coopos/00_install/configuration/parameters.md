...
Каждый из описанных ниже параметров влияет на поведение узла, производительность, безопасность и отказоустойчивость. Типовые сочетания для профилей развёртывания — в [обзоре конфигурации](index.md) и в гайдах по ролям нод. 
