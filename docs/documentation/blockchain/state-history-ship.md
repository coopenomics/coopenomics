...
В комплекте экосистемы COOPOS для подписки на поток SHiP в Node.js-приложениях используется **[Реактивный чтец SHiP](../reactive-ship-reader.md)** ([coopos-ship-reader](https://github.com/coopenomics/coopos-ship-reader) на GitHub).
...
Детали сериализации и очередей сообщений реализованы в узле; **писать свой парсер с нуля не обязательно** — опирайтесь на существующие SHiP-клиенты, в т.ч. на [Реактивный чтец SHiP](../reactive-ship-reader.md).
