...
Операционная система кооперативной экономики опирается на стек **COOPOS** — узлы, инструменты и библиотеки для распределённого реестра, сбора данных, взаимодействия с сетью и разработки смарт-контрактов. 
