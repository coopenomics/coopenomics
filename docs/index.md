!!! note "ПРИГЛАШАЕМ ИНВЕСТОРОВ"
    ...
    На текущий момент, мы завершили проектирование цифровой системы электронного документооборота для кооперативной экономики и уже больше половины года ведём её активную разработку. [Свяжитесь с нами](https://t.me/iismur), и мы познакомим Вас с благородным подходом к инвестированию при минимальных рисках. 
